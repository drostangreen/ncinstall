...
php_config(){
    ...
    sed -i "s/^;opcache\.enable=.*/opcache\.enable=1/;s/^;opcache\.interned_strings_buffer=.*/opcache\.interned_strings_buffer=20/;s/^;opcache\.max_accelerated_files=.*/opcache\.max_accelerated_files=10000/;s/^;opcache\.memory_consumption=.*/opcache.memory_consumption=128/;s/^;opcache\.save_comments=.*/opcache.save_comments=1/;s/^;opcache\.revalidate_freq=.*/opcache.revalidate_freq=1/;s|^;open_basedir.*|open_basedir = $root_dir:$log_dir:/dev/urandom:/tmp|" $php_path/php.ini
}
